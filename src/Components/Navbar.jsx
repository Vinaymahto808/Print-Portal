      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-xl shadow-lg py-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0">
                  {["Aadhaar Card", "Voter Card", "PAN Card"].map((service, index) => (
                    <a
                      key={index}
                      href="./Components/AadhaarServices"
            ...
            {/* Auth Buttons */}
            <div className="flex items-center space-x-4">
              <button className="px-4 py-2 text-gray-600 font-medium hover:text-gray-900 transition-colors">
                <a href="/Components/auth/LoginPage">Login</a>
              </button>
              <button className="px-8 py-2 text-white bg-blue-600 rounded-full hover:bg-blue-700 font-medium transition-all transform hover:scale-105">
                <a href="/Components/auth/SignupPage">Sign Up</a>
              </button>
            </div>
          </div>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 space-y-2">
            ...
            <div>
              ...
              {isServicesOpen && (
                <div className="pl-4 space-y-2">
                  <Link to="/Components/AdminDashboard" className="block py-2 text-gray-600">
                    Aadhaar Service
                  </Link>
                  <a href="#" className="block py-2 text-gray-600">
                    Voter Card Service
            ...
            <div className="pt-4 space-y-2">
              <button className="block w-full py-2 text-gray-600 text-center">
                <a href="/Components/auth/LoginPage" >Login</a>
              </button>
              <button className="block w-full px-6 py-2 text-white bg-blue-600 rounded-full text-center">
                <a href="/Components/auth/SignupPage" >Sign Up</a>
              </button>
            </div>
          </div>
